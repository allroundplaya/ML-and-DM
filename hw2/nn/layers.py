...
class Linear(Layer):
    ...
    def forward(self, x):
        ...
        ######################################################################
        out = np.matmul(self.params["w"].transpose(), x.transpose())




        # out = np.matmul(self.params['w'], x.transpose)
...
#
# linear = Linear(in_dims, out_dims, init_mode="linear")
#
